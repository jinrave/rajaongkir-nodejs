...
Pro.prototype.getSubDistricts = function (cityID) {
  var uri = this.httpUri + '/subdistrict?city=' + cityID
  var apiKey = this.apiKey
  return new Promise(function (resolve, reject) {
    request({
      uri: uri,
...
Pro.prototype.getSubDistrict = function (id) {
    var uri = this.httpUri + '/subdistrict?id=' + id
    var apiKey = this.apiKey
    return new Promise(function (resolve, reject) {
      request({
        uri: uri,
...
Pro.prototype.getCost = function (params) {
